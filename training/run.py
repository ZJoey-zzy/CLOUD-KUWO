...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_dir", type=str, default="data/MED-BBK-9K", required=False, help="input dataset file directory, ('data/DBP15K/zh_en', 'data/DWY100K/dbp_wd')")
    ...
    # Load Data
    d = AlignmentData(data_dir=args.data_dir, rate=args.rate, share=args.share, swap=args.swap, val=args.val, with_r= (args.encoder.lower()=="naea" if args.encoder else False))
    logger.info(d)
